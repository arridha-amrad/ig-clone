...
const SettingsOptions: React.FC<SettingsOptionsProps> = ({ isShow }) => {
   return (
      <ModalWrapper2 isShow={isShow}>
         ...
         <Divider />
         <ButtonLink to="/accounts/change-password">Apps and Websites</ButtonLink>
         <Divider />
         <ButtonLink to="/accounts/change-password">Notifications</ButtonLink>
         <Divider />
         <ButtonLink to="/accounts/change-password">Privacy and Security</ButtonLink>
         <Divider />
         <ButtonLink to="/accounts/change-password">Login Activity</ButtonLink>
         <Divider />
         <ButtonLink to="/accounts/change-password">Emails from Instagram</ButtonLink>
         <Divider />
