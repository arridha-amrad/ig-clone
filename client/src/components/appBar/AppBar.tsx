...
const AppBar: React.FC<AppBarProps> = () => {
   ...
   const avatar = useSelector((state: RootState) => state.auth.authenticatedUser.imageURL);
         ...
         <Nav>
            ...
            <NavContainer>
               <NavArea>
                  ...
                  <NavMenu>
                     <NavLink to="/home">
                        <Icon isSolid={pathname === "/home"} className="fas fa-home"></Icon>
                     </NavLink>

                     <NavLink to="/accounts/change-password">
                        <Icon isSolid={pathname === "/accounts/change-password"} className="fas fa-compass"></Icon>
                     </NavLink>

                     <NavLink to="/home">
                        <Icon isSolid={pathname === "/message"} className="fas fa-paper-plane"></Icon>
                     </NavLink>

                     <NavLink to="/accounts/edit">
                        <Icon isSolid={pathname === "/accounts/edit"} className="fas fa-heart"></Icon>
                     </NavLink>
...
const Icon = styled.i<IconProps>`
   ...
   -webkit-text-stroke-color: ${(props) => (props.isSolid ? "transparent" : "#000")};
`;
