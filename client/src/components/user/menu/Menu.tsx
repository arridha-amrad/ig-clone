    ...
    <ProfileMenu>
      <ProfileLink to={`/${data.username}`}>
        <MenuWrapper showFocus={pathname === `/${data.username}`}>
          <svg
            className={
              pathname === `/${data.username}` ? "svg_focus" : "svg_not_focus"
            }
            viewBox="0 0 48 48"
          >
            <path
          ...
          <Menu className={pathname === `/${data.username}` ? "" : "on"}>
            Post
          </Menu>
        </MenuWrapper>
      </ProfileLink>
      <ProfileLink to={`/${data.username}/igtv`}>
        <MenuWrapper showFocus={pathname === `/${data.username}/igtv`}>
          ...
          <Menu className={pathname === `/${data.username}/igtv` ? "" : "on"}>
            IGTV
          </Menu>
        </MenuWrapper>
      </ProfileLink>
      ...
      <ProfileLink to={`/${data.username}/saved`}>
        <MenuWrapper showFocus={pathname === `/${data.username}/saved`}>
          ...
          <Menu className={pathname === `/${data.username}/saved` ? "" : "on"}>
            Saved
          </Menu>
        </MenuWrapper>
      </ProfileLink>
      <ProfileLink to={`/${data.username}/tagged`}>
        <MenuWrapper showFocus={pathname === `/${data.username}/tagged`}>
          ...
          <Menu className={pathname === `/${data.username}/tagged` ? "" : "on"}>
            Tagged
          </Menu>
        </MenuWrapper>
      </ProfileLink>
